...
def my_generate_mindmap(o, prob_matrix, numPaires, sim_threshold, length_threshold):
    ...
    # length_threshold = 9
    # len(numPairs) 设置边的数量
    # length_threshold 设置被选入mind map的最小句子长度
    # pairs, wordPairs = truncating_tree_through_local_keywords(father_to_child, child_to_father, indexes, o, len(pairs2), sim_threshold, length_threshold)
